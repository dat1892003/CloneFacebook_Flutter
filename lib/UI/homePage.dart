...
class _HomePageState extends State<HomePage>
  ...
  Widget buildMore()  {
    ...
    List<Icon> icon = [
      ...
      Icon(Icons.flag, size: 35,color: Colors.orangeAccent,),
      Icon(Icons.access_alarm, size: 35, color: Colors.white,),
      Icon(Icons.bookmark, size: 35, color: Colors.pinkAccent,),
      Icon(Icons.video_library, size: 35, color: Colors.redAccent,),
      Icon(Icons.store, size: 35, color: Colors.black45,),
      Icon(Icons.group_add, size: 35,color: Colors.white,),
      Icon(Icons.newspaper, size: 35, color: Colors.greenAccent,),
    ];
        ...
        Container(
         ...
         Container(
            ...
            child: ElevatedButton(onPressed: (){},
              ...
              child: Text("Xem thêm",style: TextStyle(color: Colors.white),),
            ),
          ),
          Divider(),
          ExpansionTile(
          ...
          ExpansionTile(
            ...
            children: [
              ListTile(leading: Icon(Icons.edit_calendar),title: Text('Edits')),
              ListTile(leading: Icon(Icons.apple),title: Text('Threads')),
              ListTile(leading: Icon(Icons.app_blocking),title: Text('Instagram')),
              ListTile(leading: Icon(Icons.messenger_outline),title: Text('Chat với AI')),
              ListTile(leading: Icon(Icons.facebook),title: Text('Messengr')),
